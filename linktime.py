...
# 统计大于3秒响应的
    ...
    class RequestThread(threading.Thread):
        ...
        def test_performace(self):
            ...
            try:
                ...
                print ('%s:%f\n' % (self.name, time_span))
                threadnum.append(self.name)
                threadtime.append(time_span)
    ...
    print (threadnum, threadtime)
    plt.title('threadnum-time')
    plt.xlabel('threadnum')
    plt.ylabel('time')
    plt.plot(threadtime, label='time')
    plt.legend()
    plt.show()
    plt.savefig(
        '/home/xuexiaobo/Desktop/django/urls_analysis/static/linketime.png')
    '''
